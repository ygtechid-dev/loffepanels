    ...
    <>
      ...
      >
        ...
        <div className="md:w-64 border-r-2 border-gray-100 h-full flex-col flex flex-shrink-0">
          {/* Logo */}
          <div className="sidebar-logo" onClick={props.toggle}>
        <img src={Logo} alt="Logo Loffee" className="w-full h-auto" />
      </div>
          ...
          <div className="pt-2 border-t border-gray-300">
            <div className="py-2 px-4">
              {/* Logout Button */}
              <button
                className="py-2 px-4 border border-[#7F6000] bg-[#7F6000] w-full rounded-full text-gray-200 hover:bg-[#7F6000] hover:border-[#7F6000] justify-end text-sm"
                onClick={() => logout()}
              >
