...
import { ref, get } from "firebase/database"; // Pastikan file konfigurasi Firebase
...
function LoginIndex() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Referensi ke node "adminLogin" di Firebase Realtime Database
      const adminRef = ref(database, "adminlogin");
      const snapshot = await get(adminRef); // Mengambil data
      console.log({ adminRef, snapshot });
    ...
    <>
      <div className="flex min-h-screen">
        <div className="flex w-full flex-col md:flex-row">
          {/* Image */}
          <div className="md:bg-[#F7F7F0] md:min-h-screen flex flex-wrap md:w-1/2">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="flex items-center mb-6 -mt-2 md:-mt-4">
                    <div className="flex ml-auto">
                      <Link
                        ...
                        className="inline-flex font-semibold text-xs sm:text-sm text-[#7F6000]  hover:text-emerald-700"
                      >
                        Lupa password?
                      </Link>
                    </div>
                  ...
                  <div className="flex w-full">
                    <button
                      disabled={loading}
                      type="submit"
                      className="flex items-center justify-center focus:outline-none text-white text-sm bg-[#7F6000] hover:bg-emerald-700 rounded-lg md:rounded md:py-2 py-3 w-full transition duration-150 ease-in"
                    >
